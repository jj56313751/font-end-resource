<template>
<!-- better-scroll 对官网给出的例子稍作修改 -->
  <div ref="wrapper" class="list-wrapper" :style="{'top': fixTop+'px','bottom': fixBottom+'px'}">
...
export default {
  ...
  computed: {
    pullUpTxt() {
      ...
      const noMoreTxt =
        (this.pullUpLoad && this.pullUpLoad.txt && this.pullUpLoad.txt.noMore) || '没有更多内容了'
